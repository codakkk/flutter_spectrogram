...
mixin _$Sound {
  ...
  double get samplingPeriod =>
      throw _privateConstructorUsedError; // Time interval between two successive sampling points (my dx)
...
abstract class _Sound implements Sound {
  ...
  @override // nx
  double get samplingPeriod;
  @override // Time interval between two successive sampling points (my dx)
  double get timeOfFirstSample;
  @override // Seconds (x1)
  int get ymin;
